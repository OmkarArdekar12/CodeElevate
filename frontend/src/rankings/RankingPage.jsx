...
const data = {
  competitiveProgramming: [
    {
      userId: "68e6acac2e4d41a23622cf0a",
      profileId: "68e6acac2e4d41a23622cf0c",
      fullName: "Alice D",
      profilePicture: "",
      ...
      contributorScore: 0,
      allRoundersScore: 0,
      createdAt: "2025-10-08T18:25:48.182Z",
    },
    {
      userId: "68e6acac2e4d41a23622cf0a",
      profileId: "68e6acac2e4d41a23622cf0c",
    ...
    {
      userId: "68e6b1108a9c810e47b6616d",
      profileId: "68e6b1108a9c810e47b6616f",
      fullName: "Bob",
      profilePicture: "",
      headLine: "",
      cpScore: 0,
      ...
      contributorScore: 0,
      allRoundersScore: 0,
      createdAt: "2025-10-08T18:44:32.866Z",
    },
  ],
  development: [
    {
    ...
    <div className="w-full flex flex-col items-center justify-center text-white py-4 px-2 md:px-10 mb-5 transition-all duration-300 ease-in-out">
      ...
      <div className="w-full flex items-center justify-end">
        <select
          ...
          className="bg-slate-800 text-white px-4 py-2 rounded-lg border border-slate-700 focus:ring-1 focus:ring-blue-600 mb-3"
        >
          {Object.keys(rankingsDetails).map((key) => (
            <option key={key} value={key} className="bg-slate-900">
              {rankingsDetails[key].name}
            </option>
          ))}
        </select>
      </div>
