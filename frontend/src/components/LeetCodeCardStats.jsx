...
export default function LeetCodeCardStats({ leetCodeData }) {
  ...
  return (
    <div className="w-[90%] lg:w-[37%] m-1 my-4 p-6 text-white bg-gray-900 rounded-2xl shadow-xl border border-gray-100 stats-card transition-all duration-200 ease-in-out">
