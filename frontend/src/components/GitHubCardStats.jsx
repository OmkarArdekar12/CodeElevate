...
const GitHubCardStats = ({ gitHubData }) => {
  ...
  return (
    <div className="w-[90%] lg:w-[60%] m-1 my-4 p-6 text-white from-black via-gray-950 to-gray-900 bg-gradient-to-r rounded-2xl border border-gray-100 text-center stats-card">
