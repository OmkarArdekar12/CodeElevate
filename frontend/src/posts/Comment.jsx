    ...
    <div className="w-full flex flex-col mb-3 pb-2 transition-all duration-200 ease-in-out">
      <div className="w-full flex">
        ...
        <div className="w-full flex flex-col justify-center">
          <h2
            onClick={() => navigate(`/profiles/${profileUserId}`)}
            className="flex items-center font-normal text-sm text-gray-800 leading-none"
          >
            <span
              onClick={() => navigate(`/profiles/${profileUserId}`)}
        ...
        {isCommentOwner && (
          <div className="relative">
            ...
            {menuOpen && (
              <div className="absolute right-3 top-4 bg-white border rounded-lg shadow-md py-1 px-4 space-y-1 z-10">
                <button
