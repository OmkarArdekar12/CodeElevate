...
const PostCard = () => {
  ...
  const authorUsername = postData.user.username;
  const authorFullName = postData.profile.fullName;
  const authorImage = postData.profile.profilePicture;
  const authorHeadLine = postData.profile.headLine;
  const postTitle = postData.title;
  const postDescription = postData.description;
  const postImage = postData.image.url;
  const postUpdatedAtTime = new Date(postData.updatedAt).toLocaleString(
    "en-GB",
    {
      day: "2-digit",
      month: "2-digit",
