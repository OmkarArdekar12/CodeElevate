export default function TopCard({ image, text }) {
  return (
    <div
      className="TopCard flex items-center justify-center bg-gradient-to-r from-black-600 to-black-700 py-8 w-[26rem] h-45 rounded-lg border border-yellow-200 mx-10"
